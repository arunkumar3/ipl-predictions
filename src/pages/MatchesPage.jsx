...
import { getDateKey, formatDateGroup, isMatchLocked } from '../lib/utils';
...
export default function MatchesPage() {
  ...
  if (!isValidUser) {
    return <PlayerSelect onSelect={(name) => setSearchParams({ user: name })} />;
  }
